...
public class CursorTool {
	...
	public static function setCustomBlockCursor(toolName:String):void {
		hideSoftwareCursor();
		tool = toolName;
		app.enableEditorTools(tool == null);
		if (tool == null) return;
		...
		case 'stamp':
			...
			break;
		case 'eyedropper':
			showSoftwareCursor(Resources.createBmp('eyedropperCustomCursor'));
			break;
		case 'crosshair':
			showSoftwareCursor(Resources.createBmp('crosshairCustomCursor'));
			break;
		case 'eraser':
			showSoftwareCursor(Resources.createBmp('eraserCustomCursor'));
			break;
		case 'paint bucket':
			showSoftwareCursor(Resources.createBmp('paintBucketCustomCursor'));
			break;
		case 'pencil':
			showSoftwareCursor(Resources.createBmp('pencilCustomCursor'));
			break;
		case 'question mark':
			showSoftwareCursor(Resources.createBmp('questionMarkCustomCursor'));
			break;
		case 'scissors':
			showSoftwareCursor(Resources.createBmp('scissorsCustomCursor'));
			break;
		case 'wand':
			showSoftwareCursor(Resources.createBmp('wandCustomCursor'));
			break;
		case 'hidden':
