...
public class BlockMenus implements DragClient {
	...
	public static function BlockMenuHandler(evt:MouseEvent, block:Block, blockArg:BlockArg = null, menuName:String = null):void {
		...
		if (menuName == 'screenMode') menuHandler.screenModeMenu(evt);
		if (menuName == 'cursor') menuHandler.cursorMenu(evt);
		if (menuName == 'varStyle') menuHandler.varStyleMenu(evt);
		if (menuName == 'constant') menuHandler.constantMenu(evt);
		if (menuName == 'draggable') menuHandler.draggableMenu(evt);
		if (menuName == 'turbo') menuHandler.turboMenu(evt);
		if (menuName == 'opType') menuHandler.opTypeMenu(evt);
...
//			handler.scrollAlignMenu(evt);
			...
			handler.screenModeMenu(evt);
			handler.cursorMenu(evt);
			handler.varStyleMenu(evt);
			handler.constantMenu(evt);
			handler.draggableMenu(evt);
			handler.turboMenu(evt);
			handler.opTypeMenu(evt);
	...
	private function screenModeMenu(evt:MouseEvent):void {
		var m:Menu = new Menu(setBlockArg, 'screenMode');
		m.addItem('fullscreen');
		m.addItem('normal');
		m.addItem('small stage');
		showMenu(m);
	}
	private function cursorMenu(evt:MouseEvent):void {
		...
		m.addItem('paint bucket');
		m.addItem('stamp');
		m.addItem('eraser');
		m.addItem('pencil');
		m.addItem('scissors');
		m.addItem('wand');
		m.addItem('question mark');
		showMenu(m);
	}
	...
	private function constantMenu(evt:MouseEvent):void {
		var m:Menu = new Menu(setBlockArg, 'constant');
		m.addItem('pi');
		m.addItem('e');
		m.addItem('golden ratio');
		showMenu(m);
	}
	private function draggableMenu(evt:MouseEvent):void {
		var m:Menu = new Menu(setBlockArg, 'draggable');
		m.addItem('draggable');
		m.addItem('undraggable');
		showMenu(m);
	}
	
	private function turboMenu(evt:MouseEvent):void {
		var m:Menu = new Menu(setBlockArg, 'turbo');
		m.addItem('activate');
		m.addItem('deactivate');
		m.addItem('toggle');
		showMenu(m);
	}
	
	private function opTypeMenu(evt:MouseEvent):void {
		var m:Menu = new Menu(setBlockArg, 'opType');
		m.addItem('a number');
		m.addItem('a string');
		m.addItem('a boolean');
		m.addItem('a color');
	...
	private function stringAlterMenu(evt:MouseEvent):void {
		var m:Menu = new Menu(setBlockArg, 'stringAlter');
		m.addItem('uppercase');
		m.addItem('lowercase');
		m.addItem('reverse');
		m.addItem('shuffle');
		m.addItem('trim blanks of');
		showMenu(m);
	}
	
	private function customDialogOptionTypeMenu(evt:MouseEvent):void {
		var m:Menu = new Menu(setBlockArg, 'customDialogOptionType');
		m.addItem('checkboxes');
		m.addItem('radio buttons');
		showMenu(m);
	}
	
	private function customDialogFieldTypeMenu(evt:MouseEvent):void {
